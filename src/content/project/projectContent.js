...
import thePulse from '../../assets/projectTiles/thePulse.png';
...
const projectContent = Object.freeze({
    ...
    THE_PULSE: {
        NAME: 'The Pulse (backend Mar 2022, frontend Oct 2023)',
        DESCRIPTION: 
            <p className='project-description'>
                The Pulse is a news and social platform, with the aim of creating a hub for users to connect while posting articles and viewpoints on the things that interest them. The app aims to be smaller in scale than national news sites and is more focussed on connecting users, than on the content they may be connecting over.
                <br></br>
                <br></br>
                ...
                <br></br>
                <br></br>
                With the experience I have now there are definite improvements that could be made, like more efficient testing and a more responsive UI.
            </p>,
        PROJECT_TILE: thePulse,
        IMAGE: <img style={{ border: 'solid', borderWidth: '2px' }} className='rounded-box' src={thePulse} alt='website homepage' width='90%'></img>,
        HOSTED_APP_LINK: {
            displayText: 'Go to the app',
            link: 'https://the-pulse.netlify.app/',
            additionalInfo: 'For a quickstart use username and password \'rosie\'.'
        },
        SOURCE_CODE: {
            frontend: 'https://github.com/rvallely/the-pulse',
